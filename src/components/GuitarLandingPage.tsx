        ...
        <section className="bg-secondary py-8 md:py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12 bg-card border border-border rounded-xl p-6 md:p-8 hover:border-primary/50 transition-colors">
                <div className="flex-shrink-0">
                  <img
                    src={studentGuitar}
                    alt="Instrutor"
                    className="w-36 h-36 md:w-48 md:h-48 rounded-full object-cover border-4 border-primary shadow-gold"
                  />
                </div>
                <div className="space-y-4 text-center md:text-left">
                  <div>
                    <h4 className="text-xl md:text-2xl font-bold text-foreground">[Nome do Instrutor]</h4>
                    <p className="text-primary font-medium">Guitarrista & Educador Musical</p>
                  </div>
                  <p className="text-muted-foreground text-sm md:text-base">
                    Com mais de [X] anos de experiência ensinando guitarra, já formou mais de 500 alunos do zero.
                    Especialista em simplificar o processo de aprendizado, tornando o que parece impossível em algo
                    alcançável para qualquer pessoa — independente da idade ou experiência musical prévia.
                  </p>
                  <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                    {["500+ Alunos Formados", "+X Anos de Experiência", "Método Exclusivo"].map((badge, i) => (
              ...
              <p className="text-center text-xs text-muted-foreground/50 mt-3 italic">
                * Substitua a imagem e o texto acima com suas informações reais
              </p>
            </div>
          </div>
        </section>
